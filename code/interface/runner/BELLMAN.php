...
<head>
    ...
    <title id="my1">DYNAMIC SOLVE</title>
...
<input type="submit"  id="Visualtion" value="Visualisation"> 
...
var scale = 'scale(3)';
document.getElementsByClassName("zoom-m").style.webkitTransform =  scale;    // Chrome, Opera, Safari
document.getElementsByClassName("zoom-m").style.msTransform =   scale;       // IE 9
document.getElementsByClassName("zoom-m").style.transform = scale;     // General
//document.body.style.webkitTransform =  scale;    // Chrome, Opera, Safari
//document.body.style.msTransform =   scale;       // IE 9
//document.body.style.transform = scale;     // General

//document.getElementsByClassName("zoom-moz")= 'scale(10)';
